...
console.log(addArtist(artists,20,'Trey',1990 - 2020,'Web Design', 'American', 'I like things and stuff and places'))
    /* Code here */

    // artists.push({id:20, name:'Trey', years:1990-2020, genre:'Web Design', nationality:'American', bio:'jdiojijdf'  },)
